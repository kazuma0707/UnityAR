...
#endif
				float4 teleportPackedData : TEXCOORD9;

            };

#include "TeleportFade.cginc"

            VertexOutput vert (VertexInput v) {
				float warpRate = teleport_custom_vertex(v);
...
//
				...
				TELEPORT_PACKEDDATA(o, v.vertex, warpRate);
                return o;
            }
            float4 frag(VertexOutput i) : SV_TARGET {
				CLIP_TELEPORT_FADE(i.teleportPackedData);
